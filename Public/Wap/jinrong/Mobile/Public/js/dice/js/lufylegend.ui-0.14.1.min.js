...
var LCheckBox = (function() {
    ...
    LCheckBox.prototype.clone = function() {
        var s = this
            , a = new LCheckBox(s.layer.clone(),s.layerSelect.clone());
...
var LPanel = (function() {
    function LPanel(bitmapData, w, h, x1, x2, y1, y2, overlapping) {
        ...
        if (typeof bitmapData == "string") {
            ...
            d.graphics.drawRoundRect(1, "transparent", [0, 0, w, h, w < 10 ? w * 0.5 : 5], true, bitmapData);
...
var LScrollbar = (function() {
    ...
    LScrollbar.prototype.onFrame = function(event) {
        ...
        if (s.excluding) {
            for (i = 0,
                     l = s._showObject.numChildren; i < l; i++) {
    ...
    LScrollbar.prototype.scrollToBottom = function() {
        var s = this
            , h1 = s._showObject.getHeight()
            , h2 = s._mask.getHeight();
...
var LListViewDragObject = (function() {
    ...
    LListViewDragObject.prototype.inertia = function() {
        ...
        LTweenLite.to(self.listView.clipping, 0.3, {
            x: tx,
            y: ty,
            ease: LEasing.Sine.easeOut,
            onComplete: self.tweenComplete
        });
        return true;
    }
    ;
