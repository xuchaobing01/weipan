...
<div class="container-fluid">
	...
	<ul class="nav nav-tabs wm-tabs">
		...
		<li ><a href="<?php echo U('Member/order');?>">实盘流水记录</a></li>

		<li class="active"><a href="javascript:void(0)">虚拟盘流水记录</a></li>

	</ul>

	<div class="page-header wm-page-header">

	<form method="get" action="/User/Member/xuorder.html?wechat_name=&phone=&starttime=&endtime=" class="form-inline">
	 			<label>姓名</label>
	...
	<TABLE class="table wm-table-bordered table-striped table-hover">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><TR>
			...
			<TD><?php if($list["dircetion"] == 1): ?><span style="color:red">买涨</span> <?php else: ?><span style="color:green">买跌</span><?php endif; ?></TD>
			...
			<TD><?php if($list["is_win"] == 1): ?><span style="color:red">赢</span> <?php else: ?><span style="color:green">亏</span><?php endif; ?></TD>
