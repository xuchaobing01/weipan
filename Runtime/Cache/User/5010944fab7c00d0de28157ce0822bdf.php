...
<div class="container">
	<div class="page-header">
		<h3>关注时回复</h3>
		<div class="alert alert-warning">当用户关注该公众号时会触发此回复</div>
	</div>
	<div>
		<form class="form-horizontal" method="post" action="">
			<input type="hidden" id="id" value="<?php echo ($areply["id"]); ?>" name="id" />
			<div class="form-group">
				<label class="col-sm-2 control-label wm-control-label" >回复关键词</label>
				<div class="col-md-4">
					<input type="text" id="keyword" value="<?php echo ($areply["keyword"]); ?>" name="keyword" class="form-control" />
				</div>
