...
<div class="container-fluid">
	<ul class="nav nav-tabs wm-tabs">
		<li class="active"><a href="javascript:void(0)">券管理</a></li>
	 	<li><a href="<?php echo U('Member/addcoupon');?>">添加券</a></li>
	</ul>
	...
	<TABLE class="table wm-table-bordered table-striped table-hover">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><TR>
			...
			<TD><?php echo ($list["overdue_time"]); ?>天</TD>
			<TD><?php echo ($list["use_area"]); ?></TD>
			<TD>
				<a class="btn btn-xs" href="<?php echo U('Member/addcoupon', ['id'=>$list['id']]);?>">编辑</a>
				<a class="btn btn-xs" onclick="javascript:spark.confirm_jump('确定删除此券，是否确定','/User/Member/delad/id/<?php echo ($list["id"]); ?>.html')">删除</a>
			</TD>
