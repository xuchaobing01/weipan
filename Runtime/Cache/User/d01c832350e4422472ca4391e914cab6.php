	...
	<div class="tabbable-custom">
	  <!-- Nav tabs -->
		<ul class="nav nav-tabs" role="tablist">
			<li role="presentation" class="active"><a href="#" aria-controls="home" role="tab">单图文回复</a></li>
			<li role="presentation"><a href="<?php echo U('multi_img');?>" aria-controls="profile" role="tab">多图文回复</a></li>
		</ul>
	</div>
	<div class="page-header wm-page-header">
		<a class="btn btn-success" href="<?php echo U('Img/edit');?>">
		...
		<tbody>
			<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="norightborder">
					<a class="btn btn-xs btn-primary" href="<?php echo U('Img/edit',array('id'=>$vo['id']));?>" title="编辑图文自定义回复">编辑</a>
