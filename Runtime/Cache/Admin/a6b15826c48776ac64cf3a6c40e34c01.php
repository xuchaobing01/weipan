...
<html lang="zh_CN">
    <head>
        <meta charset="UTF-8">
        <title>微市场-后台登录</title>
        <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/default_color.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            <!-- 主体 -->
