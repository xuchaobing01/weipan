...
<a href="<?php echo U('edit');?>" class="btn btn-primary">添加代理</a>
<hr/>
<table class="table table-striped" id="alist">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td ><?php echo (get_agent_level($vo["level"])); ?></td>
			...
			<td>
				<a class="btn btn-default btn-xs" href="<?php echo U('edit',array('id'=>$vo['id']));?>">修改</a>
				<a class="btn btn-danger btn-xs" href="<?php echo U('del',array('id'=>$vo['id']));?>" onclick="return confirm('确定删除该用户吗?')">删除</a>
			</td>
