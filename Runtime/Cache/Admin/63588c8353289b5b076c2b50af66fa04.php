...
<div class="container2">
	<form class="form-horizontal" action="<?php echo U('edit');?>" method="post" name="form" id="myform">
		<div class="form-group">
			<label class="col-xs-2 control-label">公司名称</label>
			<div class="col-md-6">
				<input type="text" name="company" class="form-control" value="<?php echo ($info["company"]); ?>">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-6">
				<select name="level" class="form-control">
					<?php if(is_array($levels)): $i = 0; $__LIST__ = $levels;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["value"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-6">
				<input type="text" name="linkman" value="<?php echo ($vo["linkman"]); ?>" class="form-control" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label">联系电话</label>
			<div class="col-md-6">
				<input type="text" name="mobile" value="<?php echo ($vo["mobile"]); ?>" class="form-control" />
			</div>
		</div>
		<div class="form-group">
