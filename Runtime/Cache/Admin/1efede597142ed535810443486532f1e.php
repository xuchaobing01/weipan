...
<div class="container2">
	<form class="form-horizontal" action="" method="post" name="form" id="myform">
		<div class="form-group">
			<label class="col-xs-2 control-label">版本名称</label>
			<div class="col-md-6">
				<input type="text" name="name" class="form-control" value="<?php echo ($info["name"]); ?>" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label">月请求数限制</label>
			<div class="col-md-6">
				<input type="text" name="request_limit" class="form-control" value="<?php echo ($info["request_limit"]); ?>" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label">活动创建次数</label>
			<div class="col-md-6">
				<input type="text" name="activity_limit" class="form-control" value="<?php echo ($info["activity_limit"]); ?>" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label">会员卡创建数量</label>
			<div class="col-md-6">
				<input type="text" name="member_card_limit" class="form-control" value="<?php echo ($info["member_card_limit"]); ?>" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label">免费短信数量</label>
			<div class="col-md-6">
				<input type="text" name="free_sms_count" value="<?php echo ($info["free_sms_count"]); ?>" class="form-control" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-xs-2 control-label">显示版权</label>
			<div class="col-md-6">
				<label class="radio-inline">
				<input type="radio" class="radio" value="1" name="iscopyright" id="status1" <?php if(($info == '') OR ($info["iscopyright"] == 1)): ?>checked<?php endif; ?> >
				启用
				</label>
				<label class="radio-inline">
				<input type="radio" class="radio"  value="0" name="iscopyright" id="status2" <?php if(($info["iscopyright"]) == "0"): ?>checked<?php endif; ?> >
				关闭
				</label>
			</div>
		</div>
