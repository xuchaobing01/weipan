...
<head>
	...
	<script src="http://weipan.haohuajie.pw/Public/Wap/jinrong/Mobile/Public/js/jquery-1.11.3.min.js"></script>
	<script type="text/javascript">
        ...
        function ok(){
            ...
            window.location.href = "/Wap/IpsPay/index?out_trade_no=<?php echo ($out_trade_no); ?>&gatewayType=" + type;
        }
	</script>
...
<div class="roll-out-container">
	<ul>
		<li>
			<span class=""><input type="radio" name="gatewayType" value="10" checked="checked" style="vertical-align: middle;width:20px;height: 20px;"/></span>
			<span>
                      <img src="../../../Public/Wap/jinrong/Mobile/Public/images/WePayLogo.png" style="height:30px;vertical-align: middle;"/>
                    </span>
		</li>
		<li>
			<span class=""><input type="radio" name="gatewayType" value="11" style="vertical-align: middle;width:20px;height: 20px;"/></span>
			<span>
                      <img src="../../../Public/Wap/jinrong/Mobile/Public/images/alipay_logo.png" style="height:30px;vertical-align: middle;"/>
				</span>
		</li>
		<li>
			<span class=""><input type="radio" name="gatewayType" value="12" style="vertical-align: middle;width:20px;height: 20px;"/></span>
			<span>
                      <img src="../../../Public/Wap/jinrong/Mobile/Public/images/UnionPay.png" style="height:30px;vertical-align: middle;"/>
				</span>
		</li>
	</ul>
