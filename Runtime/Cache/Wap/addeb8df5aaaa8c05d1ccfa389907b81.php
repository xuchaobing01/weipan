...
<body class="page-mobile ">
    ...
    <div class="def-p txtr">
        <a href="/Wap/Login/forget_passwd.html" class="fz13 link" id="findPwd_btn">忘记密码</a>
    </div>
    <!-- 忘记密码 E -->

    <!-- 底部的注册按钮 S -->
    <div class="login-btm">
        <a href="/Wap/Login/regist" class="btn" id="register_btn">没有帐号？请注册</a>
    </div>
    <!-- 底部的注册按钮 E -->
</div>
<!-- 登录主要内容 E -->
...
<script type="text/javascript" src="<?php echo RES;?>/jinrong//Mobile/Public/js/login.js"></script>
