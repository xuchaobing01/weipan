...
class SimplePage {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'«','next'=>'»','first'=>'第一页','last'=>'最后一页','theme'=>'<ul class="pagination">%linkPage%</ul>');
    // 默认分页变量名
    protected $varPage;
    ...
    public function show() {
        ...
        $pageStr  = str_replace(array('%linkPage%'),array($linkPage),$this->config['theme']);
        return $pageStr;
    }
