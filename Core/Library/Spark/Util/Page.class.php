...
// | Page 分页控件
// +----------------------------------------------------------------------
// | Copyright (c) Spark.Tech All rights reserved.
// +----------------------------------------------------------------------
...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'«','next'=>'»','first'=>'第一页','last'=>'最后一页','theme'=>'<ul class="pagination">%upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%</ul><span class="pagination-header">%totalRow% %header% %nowPage%/%totalPage% 页</span>');
    // 默认分页变量名
    protected $varPage;
    ...
    public function __construct($totalRows,$listRows='',$parameter='',$url='') {
		//$this->config['theme'] = '<ul class="pagination">%prePage%%linkPage%%nextPage%</ul>';
